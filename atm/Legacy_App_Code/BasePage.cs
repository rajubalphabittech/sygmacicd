	...
	public abstract class BasePage : System.Web.UI.Page {
		...
		public void RegisterCommonJS() {
			...
			if (!Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType(), includeScriptKey))
				Page.ClientScript.RegisterClientScriptInclude(Page.GetType(), includeScriptKey, string.Format("{0}Scripts/Common.js", AppPath));
		}
         ...
         * 
        **/
        public void routeToHomeController()
        {
            WebCommon.routeToHomeController(this);
        }
