...
public partial class Apps_ATM_Reports_DriverPayChangeReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("9", Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text), SygmaCenterNo); // 9 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
