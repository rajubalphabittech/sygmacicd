...
public partial class Apps_ATM_Reports_MiscHoursReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("5", SygmaCenterNo, Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text)); // 5 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
