<%@ Page Title="Miles Per Gallon" Language="C#" MasterPageFile="~/Masters/ATM.master" AutoEventWireup="true" Inherits="Apps_ATM_Reports_MilesPerGallonReport" Codebehind="MilesPerGallonReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
	<div class="pageTitle inlineBlock" style="width: 75%">
    	...
    	<asp:ValidationSummary ID="vsDirectorReport" runat="server" 
        ...
        <div class="inlineBlock" style="width: 240px; margin-right: 0px;">
		    ...
		    <asp:UpdatePanel ID="upMilesPerGallonReport" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlpMilesPerGallonReport" runat="server" >
                    <table>
                <tr>
                    <td>
                        &nbsp;</td>
