<%@ Page Title="Directors Report" Language="C#" MasterPageFile="~/Masters/ATM.master" AutoEventWireup="true" Inherits="Apps_ATM_Reports_DirectorsReport" Codebehind="DirectorsReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        //                $get('lblWeekendingDate').innerHTML = dd.format("M/d/yyyy");

        //            } else {
        //                $get('lblWeekendingDate').innerHTML = '';
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <div class="panel panel-default report-panel">
        <div class="panel-title pageTitle">Directors Report</div>
            ...
            <asp:UpdatePanel ID="upTotalFuelReport" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlpTotalFuelReport" runat="server">
                        ...
                        <div class="form-group form-inline">
                            <label for="cbWeekendRange" class="col-sm-10">Run Report With Weekending Date Range</label>
                            <asp:CheckBox ID="cbWeekendRange" runat="server" />
                        </div>
