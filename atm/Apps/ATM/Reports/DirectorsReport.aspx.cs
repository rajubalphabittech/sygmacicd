...
public partial class Apps_ATM_Reports_DirectorsReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("3", SygmaCenterNo,
                Convert.ToDateTime(txtStartDate.Text), Convert.ToDateTime(txtEndDate.Text),
                Convert.ToInt16(cbWeekendRange.Checked)); // 1 � Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
