...
public partial class Apps_ATM_Reports_OdometerOverlapReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("12", Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text), SygmaCenterNo); // 12 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
