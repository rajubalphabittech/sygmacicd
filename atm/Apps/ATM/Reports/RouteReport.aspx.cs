...
public partial class Apps_ATM_Reports_RouteReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("8", Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text), SygmaCenterNo); // 8 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
