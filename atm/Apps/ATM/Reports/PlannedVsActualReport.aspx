<%@ Page Title="Planned Vs Actual Miles" Language="C#" MasterPageFile="~/Masters/ATM.master" AutoEventWireup="true" Inherits="Apps_ATM_Reports_PlannedVsActualReport" Codebehind="PlannedVsActualReport.aspx.cs" %>
...
<div class="panel panel-default report-panel">
        <div class="panel-title pageTitle">Planned vs. Actual Report</div>
            ...
            <asp:UpdatePanel ID="upTotalFuelReport" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlpTotalFuelReport" runat="server" >
                        ...
                        <div class="form-group form-inline">
                            <asp:RequiredFieldValidator CssClass="validator-message" ID="RequiredFieldValidator1" ValidationGroup="Generate"
                        ...
                        <div class="form-group form-inline">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" TargetControlID="txtEndDate" Format="M/d/yyyy" PopupPosition="Right">
                            </cc1:CalendarExtender>
                        </div>

                        <div class="form-group form-inline">
                            <asp:RequiredFieldValidator CssClass="validator-message" ID="RequiredFieldValidator2" ValidationGroup="Generate"
