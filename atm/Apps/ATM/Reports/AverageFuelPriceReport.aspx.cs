...
public partial class Apps_ATM_Reports_AverageFuelPriceReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("6", Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text), SygmaCenterNo); // 6 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
