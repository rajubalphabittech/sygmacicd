<%@ Page Title="Average Fuel Price" Language="C#" MasterPageFile="~/Masters/ATM.master" AutoEventWireup="true" Inherits="Apps_ATM_Reports_AverageFuelPriceReport" Codebehind="AverageFuelPriceReport.aspx.cs" %>
...
<div class="pageTitle inlineBlock" style="width: 75%">
		...
		Average Fuel Price Report
	</div>
	
    	<asp:ValidationSummary ID="vsAverageFuelPrice" runat="server" 
        ...
        <div class="inlineBlock" style="width: 240px; margin-right: 0px;">
		    ...
		    <asp:UpdatePanel ID="upAverageFuelPrice" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="pnlAverageFuelPrice" runat="server" style="width: 350px; margin-right: 0px;">
                    <table>
                <tr>
                    <td>
                        &nbsp;</td>
