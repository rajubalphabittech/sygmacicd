...
public partial class Apps_ATM_Reports_IndirectHoursReport : ATMReportPage
{
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var reportHasRecords = BuildExcelReport("10", Convert.ToDateTime(txtStartDate.Text),
                Convert.ToDateTime(txtEndDate.Text), SygmaCenterNo); // 10 – Report Id, Startdate, Enddate
            if (!reportHasRecords)
            {
