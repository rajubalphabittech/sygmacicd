<%@ Page Language="C#" AutoEventWireup="true" Inherits="Apps_ATM_Tools_AddTrailer" CodeBehind="AddTrailer.aspx.cs" %>
...
<body>
	<form id="form1" runat="server">
		...
		<asp:ValidationSummary ID="vsAddTrailer" runat="server"
			ValidationGroup="Add" />
		<div style="margin-top: 10px;">
			<div class="inputPanel inlineBlock" style="height: auto; width: 450px; vertical-align: top">
				...
				<div class="body">
					...
					<div id="TrailerName" style="margin-bottom: 5px">
						<div class="inlineBlock" style="font-weight: bold; width: 150px">
							Trailer Name:<span style="color: red">*</span>
						</div>
						<asp:TextBox ID="txtTrailerName" runat="server" Width="150px" MaxLength="10" autocomplete="off"></asp:TextBox>
						<asp:RequiredFieldValidator CssClass="validator-message" ID="rfvTrailerName" runat="server" ControlToValidate="txtTrailerName"
							ValidationGroup="Add" ErrorMessage="'Trailer Name' is required!">*</asp:RequiredFieldValidator>
					</div>
					...
					<div id="UnitAttachedNo" style="margin-bottom: 5px">
						<div class="inlineBlock" style="font-weight: bold; width: 150px">
							Unit Attached No:
						</div>
						<asp:TextBox ID="txtUnitAttachedNo" runat="server" Width="150px" MaxLength="20" autocomplete="off"></asp:TextBox>
					</div>
					...
					<div id="Description" style="margin-bottom: 5px">
						...
						<asp:TextBox ID="txtDescription" runat="server" Width="150px" MaxLength="25" autocomplete="off"></asp:TextBox>
					</div>
					...
					<div id="TrailerHeight" style="margin-bottom: 5px">
						<div class="inlineBlock" style="font-weight: bold; width: 150px">
							Trailer Height:
						</div>
						...
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerHeightFeet" runat="server" ControlToValidate="txtTrailerHeightFeet" MaximumValue="999"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Height Feet' must be a whole number between 0 and 999!"
						...
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerHeightInch" runat="server" ControlToValidate="txtTrailerHeightInch" MaximumValue="12"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Height Inches' must be a whole number between 0 and 12!"
							ValidationGroup="Add" ForeColor="Red" Display="Dynamic">*
						</asp:RangeValidator>
					</div>
					<div id="TrailerLength" style="margin-bottom: 5px">
						<div class="inlineBlock" style="font-weight: bold; width: 150px">
							Trailer Length:
						</div>
						...
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerLengthFeet" runat="server" ControlToValidate="txtTrailerLengthFeet" MaximumValue="999"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Length Feet' must be a whole number between 0 and 999!"
							ValidationGroup="Add" ForeColor="Red" Display="Dynamic">*
						</asp:RangeValidator>
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerLengthInch" runat="server" ControlToValidate="txtTrailerLengthInch" MaximumValue="12"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Length Inches' must be a whole number between 0 and 12!"
							ValidationGroup="Add" ForeColor="Red" Display="Dynamic">*
						</asp:RangeValidator>
					</div>
					<div id="TrailerWidth" style="margin-bottom: 5px">
						<div class="inlineBlock" style="font-weight: bold; width: 150px">
							Trailer Width:
						</div>
						...
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerWidthFeet" runat="server" ControlToValidate="txtTrailerWidthFeet" MaximumValue="999"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Width Feet' must be a whole number between 0 and 999!"
							ValidationGroup="Add" ForeColor="Red" Display="Dynamic">*
						</asp:RangeValidator>
						<asp:RangeValidator CssClass="validator-message" ID="rngTrailerWidthInch" runat="server" ControlToValidate="txtTrailerWidthInch" MaximumValue="12"
							MinimumValue="0" Type="Integer" ErrorMessage="'Trailer Width Inches' must be a whole number between 0 and 12!"
							ValidationGroup="Add" ForeColor="Red" Display="Dynamic">*
						</asp:RangeValidator>
					</div>
					...
					<div style="margin-bottom: 5px">
						<asp:Button ID="btnAdd" runat="server" Text="Add Trailer" ValidationGroup="Add" OnClick="btnAdd_Click" />
					</div>
					<div style="margin-bottom: 5px">
