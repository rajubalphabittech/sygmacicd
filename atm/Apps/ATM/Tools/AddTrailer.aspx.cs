...
public partial class Apps_ATM_Tools_AddTrailer : BasePage
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            parms[1] = txtTrailerName.Text;
            if (!IsTrailerExist(parms[1].ToString(), Convert.ToInt32(parms[0])))
            {
                if (txtUnitNo.Text != "")
                {
                ...
                parms[3] = txtUnitAttachedNo.Text;
                parms[4] = Convert.ToInt32(ddMake.SelectedValue);
                parms[5] = txtVIN.Text;
                parms[6] = ddReplacedYear.SelectedValue;
                parms[7] = txtModel.Text;
                ...
                int trailerHeightFeet = 0;
                int trailerHeightInch = 0;
                int trailerLengthFeet = 0;
                int trailerLengthInch = 0;
                int trailerWidthFeet = 0;
                int trailerWidthInch = 0;
                if (txtTrailerHeightFeet.Text != "")
                {
                    trailerHeightFeet = Convert.ToInt32(txtTrailerHeightFeet.Text);
                }
                if (txtTrailerHeightInch.Text != "")
                {
                    trailerHeightInch = Convert.ToInt32(txtTrailerHeightInch.Text);
                }
                if (txtTrailerLengthFeet.Text != "")
                {
                    trailerLengthFeet = Convert.ToInt32(txtTrailerLengthFeet.Text);
                }
                if (txtTrailerLengthInch.Text != "")
                {
                    trailerLengthInch = Convert.ToInt32(txtTrailerLengthInch.Text);
                }
                if (txtTrailerWidthFeet.Text != "")
                {
                    trailerWidthFeet = Convert.ToInt32(txtTrailerWidthFeet.Text);
                }
                if (txtTrailerWidthInch.Text != "")
                {
                    trailerWidthInch = Convert.ToInt32(txtTrailerWidthInch.Text);
                }
                parms[20] = (trailerHeightFeet * 12) + trailerHeightInch;
                parms[21] = (trailerLengthFeet * 12) + trailerLengthInch;
                parms[22] = (trailerWidthFeet * 12) + trailerWidthInch;
                ...
                gATMDB.RunNonQuery("up_p_AddATMTrailer", parms);
                this.Javascript.Notify("Trailer added to ATM successfully");
                ResetForm();
            }
            else
            {
                this.Javascript.Notify("Trailer is already present in ATM!");
                ResetForm();
            }
        }
        catch (Exception exp)
        {
            throw new Exception("Error adding Trailer to ATM import exception", exp);
        }
    }

    private bool IsTrailerExist(string trailerSygmaId, int center)
    {
        bool exist = Convert.ToBoolean(gATMDB.GetScalar("up_p_IsTrailerExist", trailerSygmaId, center));
        return exist;
    }
    ...
    public void ResetForm()
    {
        ...
        txtTrailerName.Text = null;
        txtUnitNo.Text = null;
        txtUnitAttachedNo.Text = null;
        ...
        txtTrailerHeightFeet.Text = null;
        txtTrailerHeightInch.Text = null;
        txtTrailerLengthFeet.Text = null;
        txtTrailerLengthInch.Text = null;
        txtTrailerWidthFeet.Text = null;
        txtTrailerWidthInch.Text = null;
