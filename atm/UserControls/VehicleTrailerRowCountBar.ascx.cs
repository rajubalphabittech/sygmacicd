...
public partial class UserControls_VehicleTrailerRowCountBar : System.Web.UI.UserControl
{
    ...
    {
        get { return Convert.ToInt32(lblVehiclesCount.Text); }
        set { lblVehiclesCount.Text = value.ToString(); }
    }

    public int TrailersCount
    {
        get { return Convert.ToInt32(lblTrailersCount.Text); }
        set { lblTrailersCount.Text = value.ToString(); }
    }
